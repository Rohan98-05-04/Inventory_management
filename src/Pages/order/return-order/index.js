...
export default function UpdateOrder() {
  ...
  const orderItemId = returnid.returnid;
    ...
    if (orderItemId) {
      ...
      const fetchProductDataById = async (orderItemId) => {
        ...
        if (response.ok) {
          ...
          setMinDate(data?.result?.OrderDate.slice(0, 10) || " ")
          // setTotalAmount(data?.result?.TotalAmount|| " ")
          setStatus(data?.result?.Status || " ");
          setQuantity(data?.result?.actualQuantity || " ");
          //setReturnQuantity(data?.result?.returnQuantity || " ")
  ...
  const updateOrderCategoryById = (orderItemId) => {
    ...
    // }
    // const intReturnQuantity=parseInt(returnQuantity,10)

    //Convert the string returnquantity to int 
    const updatedArray = tableProductsData.map((obj) => ({
      ...obj,
      returnQuantity: typeof obj.returnQuantity === 'string' ? parseInt(obj.returnQuantity, 10) || 0 : obj.returnQuantity,
    })); 
    let orderDetail = {
      ...
      returnDate: returnDate.trim() ? returnDate : undefined,
      // Quantity:
      //   Quantity !== undefined && Quantity !== null && Quantity !== 0
      //     ? Quantity
      //     : undefined,
      // returnQuantity:
      // intReturnQuantity !== undefined && intReturnQuantity !== null && intReturnQuantity !== 0
      //     ? intReturnQuantity
      //     : undefined,
    ...
    const fetchData = async () => {
      const response = await fetch(
        `${API_BASE_URL}/order/returnOrder/${orderItemId}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
      ...
      <div className="donarPage w-100">
        ...
        <div className="addDonarForm">
          <h2 className={`${styles.formHeaderext}`}>
            Update the Return Order Details
          </h2>
          <form>
            <div className="formMainDiv">
              <div className="label-form eventInp">
                <label htmlFor="customerid" className="required">Customer</label>
                <br />
                <Select 
                   name="customerid"
            ...
            <div className="label-form eventInp">
              ...
              <div className="label-form eventInp">
                ...
                <br />
                <select onChange={(e) => setStatus(e.target.value)} disabled>
              ...
              <div className="label-form eventInp">
                <label htmlFor="orderdate">Return Date</label>
                <br />
                <input
                  type="date"
                  id="name"
            ...
            <div className="table-responsive w-100">
              ...
              <table className="table">
                ...
                <tr>
                    ...
                    <th scope="col" className="required">Quantity</th>
                    <th scope="col" className="required">Return Quantity</th>
